...
class IndexMinHeap:
    ...
    def __init__(self,capacity):
        self.count=0
        self.data=[None for n in range(capacity+2)]
        self.indexs = [None for n in range(capacity + 2)]
    def size(self):
        return self.count
    def isEmpty(self):
        return self.count==0
    ...
    def change( self,i,item ):
        ...
        for j in range(1,self.count+1):
            if( self.indexs[j] == i ):
                ...
                return;
    def hasIndex(self,i):
        return not self.data[i+1]==None
if __name__=='__main__':
    heap=IndexMinHeap(20)
